...
namespace OpenCVForUnity.DnnModel
{
    /// <summary>
    ...
    public class MediaPipeHandPoseEstimator
    {
        ...
        public virtual void visualize(Mat image, Mat result, string poseString, float poseConf, bool print_result = false, bool isRGB = false)
        {
            if (image.IsDisposed)
                return;
            ...
            Imgproc.putText(image, poseString, new Point(left, top - 8), Imgproc.FONT_HERSHEY_DUPLEX, 3, point_color, 3);
            Imgproc.putText(image, "Hand: " + handedness_text, new Point(left, top + 36), Imgproc.FONT_HERSHEY_DUPLEX, 1, point_color, 2);
            Imgproc.putText(image, "Pose Conf: " + poseConf.ToString("F3"), new Point(left, top + 72), Imgproc.FONT_HERSHEY_DUPLEX, 1, point_color, 2);
            Imgproc.putText(image, "Hand Conf:" + confidence.ToString("F3"), new Point(left, top + 108), Imgproc.FONT_HERSHEY_DUPLEX, 1, point_color, 2);
